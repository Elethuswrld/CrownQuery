        ...
        <div className="bg-white py-20">
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div className="text-center mb-12">
                    <h2 className="text-4xl font-extrabold tracking-tight text-gray-900 font-montserrat">Discover Your Style</h2>
                    <p className="mt-4 text-lg text-gray-600">Explore our collections by the aesthetic that inspires you.</p>
                </div>
                        ...
                        <Link key={style.name} href={style.href} passHref>
                            <div className="group block relative h-96 w-full overflow-hidden rounded-lg shadow-lg transform transition-transform duration-300 hover:scale-105">
                                ...
                                <div className="absolute inset-0 flex items-center justify-center">
                                    <h3 className="text-2xl font-bold text-white text-shadow-md group-hover:text-gold transition-colors duration-300 font-montserrat">{style.name}</h3>
                                </div>
                            </div>
                        </Link>
                    ))}
